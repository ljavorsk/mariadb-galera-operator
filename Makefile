...
# ljavorsk/mariadb-galera-operator-bundle:$VERSION and ljavorsk/mariadb-galera-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/ljavorsk/mariadb-galera-operator
